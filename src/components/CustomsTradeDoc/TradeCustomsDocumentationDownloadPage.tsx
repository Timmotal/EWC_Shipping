...
import ConsignementFile from "./ConsignementFile";

const TradeCustomsDocumentationDownloadPage = () => {
  ...
  return (
    ...
    <div className="self-stretch rounded-lg flex flex-col items-start justify-start pt-8 px-8 pb-8 gap-[20px] max-w-full">
      {/* This belongs in another component */}
...
export default TradeCustomsDocumentationDownloadPage