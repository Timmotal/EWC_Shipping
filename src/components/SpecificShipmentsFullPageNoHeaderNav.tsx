...
const SpecificShipmentsFullPageNoHeaderNav = () => {
  ...
  return (
    <div
      className={`self-stretch rounded-lg flex flex-col items-start justify-start pb-5 px-8 pt-8 gap-[20px] max-w-full text-left text-xl text-black `}
    >
     ...
     {/* SPECIFIC SHIPMENT DOCS DEPENDENCIES SECTION */}
      <div className="self-stretch flex flex-col items-start justify-start gap-7 pt-7 ">
                <div className="self-stretch flex flex-col items-start justify-start gap-2 ">
                  <div className="self-stretch flex flex-row items-start justify-end">
                    ...
                    Bill of Ladings and Booking Confirmation
                    </b>
                  </div>
                  <div className="self-stretch flex flex-row items-start justify-end">
                ...
                <div className="self-stretch flex flex-col items-start  justify-start gap-2 text-lg">
                  ...
                  <div className="self-stretch shadow-[0px_1px_5.7px_rgba(16,_24,_40,_0.08)] rounded-lg overflow-hidden flex flex-row items-center justify-start p-2 gap-[50px] border-[1px] border-solid">
                    ...
                    <div className="flex flex-row items-center justify-start">
                      ...
                      <div className="relative text-lz text-[#37383a]">
      ...
      {/* SPECIFIC SHIPMENT CHAT SECTION */}
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-2">
              ...
              <div className="self-stretch shadow-[0px_1px_5.7px_rgba(16,_24,_40,_0.08)] rounded-lg overflow-hidden flex flex-col items-start justify-center p-4 gap-[16px] text-lg border-[1px] border-solid">
                ...
                <div className="self-stretch flex flex-row items-center justify-end gap-[16px]">
                  ...
                  <div className="w-16 rounded-full h-16 overflow-hidden shrink-0 flex flex-row items-center justify-center p-2 box-border relative gap-[6px] bg-[url('/public/User3.png')] bg-cover bg-no-repeat bg-[top]  ">
                  {/* USER CHAT PICTURE RIGHT SIDE */}
                  </div>
                </div>
                <div className="self-stretch bg-[#F2F4F7] rounded-lg flex flex-row items-center justify-start p-2 gap-[10px]">
                  <img
...
export default SpecificShipmentsFullPageNoHeaderNav;
