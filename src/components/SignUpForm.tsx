      ...
      <div className="w-[38.125rem] shadow-[0px_1px_5.7px_rgba(16,_24,_40,_0.08)] bg-[#FFFFFF] z-10 rounded-lg  box-border flex flex-col items-start justify-start p-[1.937rem] gap-[2rem] max-w-full border-[0.5px] border-solid ">
        ...
        <form className="m-0 self-stretch flex flex-col items-start justify-start gap-[1.25rem] max-w-full">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-4 max-w-full">
            <b className="self-stretch relative text-2xl text-black text-left ">
              Business phone
            </b>
            <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[0.5rem] max-w-full">
              <div className="w-24 rounded box-border overflow-hidden shrink-0 flex flex-row items-center justify-center py-[0.375rem] px-[0.437rem] gap-[0.375rem] border-[1px] border-solid">
                ...
                <div className="relative flex justify-center items-center text-center  min-w-12">
                  <span className="text-base leading-[1.5rem] pr-1">{`+44 `}</span>
              ...
              <div className="flex-1 rounded-md bg-white box-border overflow-hidden flex flex-row items-center justify-start min-w-72 max-w-full border-[1px] border-solid">
                <input
                  className="w-full [border:none] [outline:none] bg-[transparent] h-[2.5rem] flex-1 flex flex-row items-center justify-start py-[0.5rem] px-[0.75rem] box-border text-base min-w-64 max-w-full"
            ...
            <div className="self-stretch flex flex-row items-start justify-start max-w-full">
              <div className="flex-1 flex flex-row items-center justify-start gap-[0.5rem] max-w-full">
                <input
                  ...
                  type="checkbox"
                />
                <div className="flex-1 relative text-[1rem] leading-[1.5rem] text-black text-left inline-block max-w-[calc(100%_-_28px)]">
